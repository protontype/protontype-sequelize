...
export declare class SequelizeModelConfig {
    static modelsList: SequelizeBaseModel<any>[];
    static add(model: SequelizeBaseModel<any>): void;
}
/**
 * Decorator
 *
 ...
 * Load a model
 */
export declare function LoadModel(config: SequelizeBaseModel<any>): (constructor: Function) => void;
/**
 * Decorator
 */
